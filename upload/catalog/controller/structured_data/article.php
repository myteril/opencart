...
class Article extends \Opencart\System\Engine\Controller {
	 ...
	 * @param array $authors
	 * @param array $images
	 * @param string|int $date_published
	 * @param string|int $date_modified
	 * @return string
	 */
	public function index(string $title, array $authors, array $images, string|int $date_published, string|int $date_modified): string {
		$data = [];
